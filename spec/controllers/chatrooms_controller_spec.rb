...
RSpec.describe ChatroomsController, :type => :controller do
    ...
    describe '#create' do
        ...
        it 'edit chatroom parameters' do
            room = create(:chatroom, title: 'Title', details: 'This is a chatroom test case', gender: 'Male Only', 
                            collegestudent: 'No College Student', minimumage: 30, maximumage: 40, visible: true,
